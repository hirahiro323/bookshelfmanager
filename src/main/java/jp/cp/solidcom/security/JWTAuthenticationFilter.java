...
import static jp.cp.solidcom.security.Constants.EXPIRATION_TIME;
import static jp.cp.solidcom.security.Constants.HEADER_STRING;
import static jp.cp.solidcom.security.Constants.LOGIN_ID;
import static jp.cp.solidcom.security.Constants.LOGIN_URL;
import static jp.cp.solidcom.security.Constants.PASSWORD;
import static jp.cp.solidcom.security.Constants.SECRET;
import static jp.cp.solidcom.security.Constants.TOKEN_PREFIX;
	...
	public Authentication attemptAuthentication(HttpServletRequest req, HttpServletResponse res)
		...
		try {
			...
			return authenticationManager.authenticate(new UsernamePasswordAuthenticationToken(userForm.getLoginId(),
					userForm.getPass(), new ArrayList<>()));
		} catch (IOException e) {
